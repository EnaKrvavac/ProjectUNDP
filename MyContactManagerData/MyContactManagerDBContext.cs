...
namespace MyContactManagerData
{
    public class MyContactManagerDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                x.HasData(
                    new State() { Id = 1, Name = "None", Abbreviation = "NA" },
            ...
            {
                x.HasData(
                    new Country() { Id = 1, CountryName = "BiH", },
                    new Country() { Id = 2, CountryName = "Croatia", },
                    new Country() { Id = 3, CountryName = "Montenegro", },
                    new Country() { Id = 4, CountryName = "Slovenia", },
                    new Country() { Id = 5, CountryName = "Italy", },
                    new Country() { Id = 6, CountryName = "Belgium", },
                    new Country() { Id = 7, CountryName = "USA", },
                    new Country() { Id = 8, CountryName = "UK", },
                    new Country() { Id = 9, CountryName = "Poland", },
                    new Country() { Id = 10, CountryName = "Turkey", }
